...
file = open(data_path + 'Label/training.txt', 'r')

spatial_cue_list = np.zeros(shape=[7000, 3], dtype=float)
relation_traits_list = np.zeros(shape=[7000, 8], dtype=float)
# face_1_list = [None] * 7000
# face_2_list = [None] * 7000

face_1_list = np.full(shape=[7000, 100,100, 3], fill_value=255, dtype=float)
face_2_list = np.full(shape=[7000, 100,100, 3], fill_value=255, dtype=float)
...
transfer_values_face_1 = transfer_values_cache(cache_path=output_path + 'inception_face_1_train.pkl', images=face_1_list, model=model)
transfer_values_face_2 = transfer_values_cache(cache_path=output_path + 'inception_face_2_train.pkl', images=face_2_list, model=model)
...
np.save(output_path + 'softmax_vector.npy', conc)
np.save(output_path + 'relation_traits_vector.npy', relation_traits_list)
