...
# 1. Downloads the aflw dataset
# 2. Fine-tunes an Inception_ResNet_V2 model on the aflw training set.
# 3. Evaluates the model on the aflw validation set.
#
# Usage:
# cd slim
# ./slim/scripts/finetune_inception_resnet_v2_on_aflw.sh
...
TRAIN_DIR=output/aflw-models/inception_resnet_v2

# Where the dataset is saved to.
DATASET_DIR=../dataset/aflw
