...
# 2. Fine-tunes an Inception_ResNet_V2 model on the mnist training set.
# 3. Evaluates the model on the mnist validation set.
#
# Usage:
# cd slim
# ./slim/scripts/finetune_inception_resnet_v2_on_mnist.sh

# Where the pre-trained Inception_ResNet_V2 checkpoint is saved to.
PRETRAINED_CHECKPOINT_DIR=/tmp/checkpoints

# Where the training (fine-tuned) checkpoint and logs will be saved to.
TRAIN_DIR=/tmp/mnist-models/inception_resnet_v2
